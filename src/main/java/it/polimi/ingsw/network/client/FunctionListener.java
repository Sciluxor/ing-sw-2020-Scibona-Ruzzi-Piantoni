...
public interface FunctionListener {
    ...
    /**
     * Function that handle the graphical update of the players in the lobby
     */

    void updateLobbyPlayer();

    /**
     * Function that notify the Client that the nickName selected is already in use in the Game
     */

    void nickUsed();

    /**
     * Function that notify the Client that the game is about to Start (The Lobby is Full)
     */
    ...
    /**
     * Function that handle the Challenger phase
    ...
    /**
     * Function that handle the Card Choice phase
    ...
    /**
     * Function that handle the Place Workers phase
    ...
    /**
     * Function that handle the graphical update of the board after the workers of the other Clients are placed
    ...
    /**
     * Function that handle the graphical update of the board after a move or build of other Clients
    ...
    /**
     * Function that notify the Client that there is a loser
     * @param nick NickName of the Winner
    ...
    /**
     * Function that handle the graphical display of the actions available in that moment(build,move,end turn)
    ...
    /**
     * Function that add constraint to the Client
    ...
    /**
     * Function that remove constraint from the Client
    ...
    /**
     * Function that handle the Turn Time ended event
    ...
    /**
     * Function called when a Client leave the game and stop the game
    ...
    /**
     * Function called when the client get disconnected from the lobby (timer ended), notify the Client
     */

    void onLobbyDisconnection();

    /**
     * Function called when the client don't receive ping messages from the server, notify the Client
     */

    void onPingDisconnection();

    /**
     * Function called if the Client get disconnected after the game is ended
     */

    void onEndGameDisconnection();

    /**
     * Function that handle new chat messages written by other clients
    ...
    /**
     * Function that handle non official CLI or GUI Version, called when the Server detect an error in the Messages
    ...
    /**
     * Function called when the Client send a message during the turn of the other Clients (except chat messages)
     */
