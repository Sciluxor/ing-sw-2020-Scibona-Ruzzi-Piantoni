...
class GameMapTest {
    ...
    void setup(){
        ...
        map.getMap().get(22).setMovement(player1,player1.getWorkers().get(0));
        player1.getWorkers().get(0).setBoardPosition(map.getMap().get(22));
        map.getMap().get(4).setMovement(player1,player1.getWorkers().get(1));
        player1.getWorkers().get(1).setBoardPosition(map.getMap().get(4));
        map.getMap().get(21).setMovement(player2,player2.getWorkers().get(0));
        player2.getWorkers().get(0).setBoardPosition(map.getMap().get(21));
        map.getMap().get(18).setMovement(player2,player2.getWorkers().get(1));
        player2.getWorkers().get(1).setBoardPosition(map.getMap().get(18));


    }
    @Test
    void reachableSquares() {
        map.getMap().get(5).setBuilding(Building.LVL3);
        map.getMap().get(5).addBuildingLevel();
        map.getMap().get(5).addBuildingLevel();
        map.getMap().get(5).addBuildingLevel();
        ...
        map.getMap().get(21).addBuildingLevel();
        map.getMap().get(21).addBuildingLevel();
        map.getMap().get(21).setBuilding(Building.LVL2);

        map.getMap().get(24).setBuilding(Building.DOME);
        map.getMap().get(19).setBuilding(Building.DOME);
        map.getMap().get(20).setBuilding(Building.DOME);

        map.getMap().get(9).addBuildingLevel();
        map.getMap().get(9).addBuildingLevel();
        map.getMap().get(9).addBuildingLevel();
        map.getMap().get(9).addBuildingLevel();
        map.getMap().get(9).setBuilding(Building.DOME);

        map.getMap().get(10).addBuildingLevel();
        map.getMap().get(10).addBuildingLevel();
        map.getMap().get(10).addBuildingLevel();
        map.getMap().get(10).setBuilding(Building.LVL3);
    ...
    void moveWorkerTo() {
        ...
        assertEquals(player2.getCurrentWorker().getPreviousBoardPosition(),map.getMap().get(21));
        assertEquals(player2.getCurrentWorker().getBoardPosition(),map.getMap().get(23));
        ...
        assertEquals(map.getModifiedSquare().get(0),map.getMap().get(21));
        assertEquals(map.getModifiedSquare().get(1),map.getMap().get(23));
    }
    ...
    void buildInSquare() {
        ...
        assertEquals(map.getModifiedSquare().get(0),map.getMap().get(10));
        ...
        assertEquals(map.getModifiedSquare().get(0),map.getMap().get(11));

        map.getMap().get(23).addBuildingLevel();
        map.getMap().get(23).setBuilding(Building.LVL1);

        assertTrue(map.buildInSquare(player2.getCurrentWorker(),Directions.NORD_OVEST,Building.LVL2));
        assertEquals(map.getModifiedSquare().get(0),map.getMap().get(23));
    ...
    void isInPerimeter() {
        ...
        assertTrue(map.isInPerimeter(map.getMap().get(1).getTile()));
        assertTrue(map.isInPerimeter(map.getMap().get(15).getTile()));
        assertFalse(map.isInPerimeter(map.getMap().get(16).getTile()));
    ...
    void addModifiedSquare() {
        assertEquals(0,map.getModifiedSquare().size());
        map.addModifiedSquare(map.getMap().get(23));
        assertEquals(map.getModifiedSquare().get(0), map.getMap().get(23));
    }
    ...
    void clearModifiedSquare() {
        ...
        map.addModifiedSquare(map.getMap().get(23));
        assertEquals(map.getModifiedSquare().get(0), map.getMap().get(23));
        map.addModifiedSquare(map.getMap().get(17));
        assertEquals(map.getModifiedSquare().get(1), map.getMap().get(17));
